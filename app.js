...
const favoriteAcademyRoutes = require('./routes/favRoutes'); 
// Start express app
const app = express();
...
app.use('/api/favorites', favoriteAcademyRoutes);
app.use('/docs', swaggerUI.serve, swaggerUI.setup(swaggerSpec));
//ROUTES <dont remove this line>
app.use('/api/v1.0.0/lists', listRouter);
app.use('/api/v1.0.0/teachers', teacherRouter);
app.use('/api/v1.0.0/academies', academyRouter);
